...
| ed2curve key conversion | npm `ed2curve@0.3.0`, integrity `sha512-8w2fmmq3hv9rCrcI7g9hms2pMunQr1JINfcjwR9tAyZqhtyaMN991lF/ZfHfr5tzZQ8c7y7aBgZbjfbd0fjFwQ==` | Unlicense in package metadata and installed `LICENSE` | Ed25519 public/secret conversion before raw X25519 agreement for QDM1 and Qortal legacy direct messages | Dependency API use; no protocol implementation copied | Approved and pinned |
| Qortium direct-chat vectors | Qortium Core `src/test/resources/chat/interop/chat-crypto-v1.json` at the Core commit pinned by `scripts/lib/chat-interop-fixtures.mjs` | Qortium project license and local authoritative fixture | Byte-exact QDM1 shared secret, KDF, AES-GCM envelope, sender/recipient reopen, and negative cases | Fixture consumed directly; Home implementation is original | Approved and tested |
