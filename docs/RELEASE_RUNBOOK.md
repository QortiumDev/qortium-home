...
state remain intact, the installed version is 2.1.0-beta.11 (code 53), the app starts,
...
semantic versions. A developer build named 2.1.0 sorts after 2.1.0-beta.11, so
