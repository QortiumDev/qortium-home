...
over the previous prerelease package (2.1.0-beta.4, code 46) and, when a device is
available, over the public Home 1.8.0 package (code 41). Verify that application data and account
state remain intact, the installed version is 2.1.0-beta.5 (code 47), the app starts,
...
semantic versions. A developer build named 2.1.0 sorts after 2.1.0-beta.5, so
