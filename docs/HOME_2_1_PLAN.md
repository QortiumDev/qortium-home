...
- [x] Prepare Home 2.1.0 release metadata and mechanics. Desktop/package
  metadata is 2.1.0-beta.2, Android is version name 2.1.0-beta.2 and code 44 (beta.1
  used code 43), both Home 2 hosts advertise QAVS 2.1 and host version 2.1.0-beta.2,
