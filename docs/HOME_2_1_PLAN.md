...
- [x] Prepare Home 2.1.0 release metadata and mechanics. Desktop/package
  metadata is 2.1.0-beta.10, Android is version name 2.1.0-beta.10 and code 52 (beta.1
  used code 43, beta.2 code 44, beta.3 code 45, beta.4 code 46, beta.5 code 47, beta.6 code 48, beta.7 code 49, beta.8 code 50, beta.9 code 51), both Home 2 hosts advertise QAVS 2.1 and host version 2.1.0-beta.10,
