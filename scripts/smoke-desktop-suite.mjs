...
const SMOKES = [
  ...
  { script: 'smoke:desktop:home-v2-account-launch', needs: 'none',
    note: 'Pin/account attribution and current-URL navigation, saves, duplicate/reopen and process restore. Disposable vault/loopback fixture, locally verified, not yet hosted CI.' },
  ...
  { script: 'smoke:desktop:home-v2-release-notes', needs: 'internet', flaky: true,
    note: 'fetches api.github.com. Was timing out since first-run onboarding began opening a Welcome tab that takes the active tab (the overlay landed on a covered tab); fixed 2026-09-13 by waiting for the shell restore and dismissing setup before navigating.' },
