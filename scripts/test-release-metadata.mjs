...
const expectedVersion = '2.1.0-beta.9';
...
// beta.3 used 45, beta.4 46, beta.5 47, beta.6 48, beta.7 49, beta.8 50, beta.9 advances to 51.
const expectedAndroidVersionCode = 51;
