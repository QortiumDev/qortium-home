...
const expectedVersion = '2.1.0-beta.12';
...
// beta.3 used 45, beta.4 46, beta.5 47, beta.6 48, beta.7 49, beta.8 50, beta.9 51, beta.10 52, beta.11 53, beta.12 advances to 54.
const expectedAndroidVersionCode = 54;
