...
import { describeHomeV2PublishSourcePath } from './home-v2-publish-source-selection.js'
import {
...
try {
  ...
  const source = await describeHomeV2PublishSourcePath(sourcePath, 'file', undefined, bytes.length)
