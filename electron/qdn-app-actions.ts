...
export const QDN_ASSET_READ_ACTIONS = ['GET_ASSET_INFO', 'GET_ASSET_BALANCES', 'GET_ASSET_TRANSFERS'] as const;
...
// Home-local, user-owned QDN launch assignments. Every mutation is confirmed
// by Home; these stay available on network nodes because no node access occurs.
export const QDN_APP_ASSIGNMENT_ACTIONS = ['GET_APP_ASSIGNMENTS', 'REQUEST_APP_ASSIGNMENT'] as const;
