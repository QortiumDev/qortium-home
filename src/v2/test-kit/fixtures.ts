...
export const homeV2Fixture: HomeV2Snapshot = deepFreeze({
  ...
  nodes: {
    ...
    qortium: {
      ...
      i2pDataSessionUp: true,
      i2pChainLeaseSetLookupStatus: 'RESOLVED',
      i2pDataLeaseSetLookupStatus: 'RESOLVED',
      i2pChainLeaseSetLookupTimestamp: 1_774_999_900_000,
      i2pDataLeaseSetLookupTimestamp: 1_774_999_910_000,
      i2pChainLastInboundHandshakeTimestamp: 1_774_999_980_000,
      i2pDataLastInboundHandshakeTimestamp: 1_774_999_970_000,
      syncPercent: 100,
      syncPhase: 'SYNCED',
      lastCheckedAt: 1_775_000_000_000,
      error: null,
