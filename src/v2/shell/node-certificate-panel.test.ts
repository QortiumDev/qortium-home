...
assert.equal(needsCertificateConfirmation('https://127.0.0.2:24891'), false)
assert.equal(needsCertificateConfirmation('https://127.99.1.1'), false)
assert.equal(needsCertificateConfirmation('https://128.0.0.1'), true)
