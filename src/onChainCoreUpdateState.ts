...
export function useOnChainCoreUpdate(nodeSettings: QortiumNodeSettings | null, nodeEpoch = 0) {
  ...
  }, [nodeEpoch, nodeSettings?.apiKey, nodeSettings?.mode, nodeSettings?.nodeApiUrl]);
