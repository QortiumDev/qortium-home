...
// Reads the four big-endian signed-irrelevant 64-bit lanes from the 32-byte hash.
// We keep them as unsigned 64-bit BigInts; all arithmetic is mod 2^64 so the
// signed/unsigned distinction does not affect results.
